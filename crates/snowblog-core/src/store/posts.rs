...
impl Store {
    pub async fn create_post(&self, new: NewPost) -> Result<PostRecord, StoreError> {
        ...
        .await;
        record_store(StoreOperation::CreatePost, &result, started.elapsed());
        result
    }
    ...
    pub async fn update_post_meta(
        ...
        .await;
        record_store(StoreOperation::UpdatePostMeta, &result, started.elapsed());
        result
    }
    ...
    pub async fn set_status(
        ...
        let result = async {
            ...
            if let Some(default_ts) = published_at_if_unset {
                sqlx::query(
                    "UPDATE posts SET published_at = ? WHERE id = ? AND published_at IS NULL",
                )
        ...
        .await;
        record_store(StoreOperation::SetStatus, &result, started.elapsed());
        result
    }
    ...
    pub async fn delete_post(&self, slug: &Slug, expected: Revision) -> Result<(), StoreError> {
        ...
        .await;
        record_store(StoreOperation::DeletePost, &result, started.elapsed());
        result
    }
