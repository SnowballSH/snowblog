...
export class BlogModel {
    ...
    static getAllSummaries(): BlogSummary[] {
        try {
            ...
            for (const row of blogRows) {
                const [id, title, content, createdAt] = row as [string, string, string, string];
    ...
    static getById(id: string): Blog | null {
        try {
            ...
            const [blogId, title, content, createdAt] = blogRows[0] as [string, string, string, string];
    ...
    static search(keyword: string): BlogSummary[] {
        try {
            ...
            const blogRows = db.query(`
                ...
                ORDER BY createdAt DESC
            `, [searchTerm, searchTerm]) as QueryResult;
